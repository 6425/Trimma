      ...
      >
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <p className="mb-2 inline-flex items-center gap-2 rounded-full bg-[#ffc800]/15 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-yellow-700">
            ...
            <p id="cookie-consent-description" className="mt-2 text-sm leading-6 text-zinc-600 dark:text-zinc-300">
              ...
              <Link href="/cookies" className="font-semibold text-zinc-900 underline decoration-[#ffc800] decoration-2 underline-offset-4 dark:text-white">
                Cookie Policy
              </Link>
              .
            </p>
          ...
          <div className="mt-5 border-t border-zinc-100 pt-5 dark:border-zinc-800">
              ...
              {preferenceOptions.map((option) => (
                ...
                >
                  <input
                    ...
                    className="mt-1 h-4 w-4 rounded border-zinc-300 text-zinc-900 focus:ring-[#ffc800]"
                  />
                  <span>
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:justify-end">
              ...
              <button
                ...
                className="h-11 rounded-xl bg-[#ffc800] px-4 text-sm font-bold text-zinc-900 transition-colors hover:bg-[#e6b400]"
              >
                Save preferences
              </button>
            </div>
