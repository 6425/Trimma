...
export default function AdminUserCreate() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => navigate(formData.role === "agent" ? "/admin/users/agents" : "/admin/users/all"), 2000);
    } catch (error: any) {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    required
                  >
                    <SelectTrigger className="h-12 bg-zinc-50 border-none focus:ring-2 focus:ring-[#D81E5B]/20 rounded-xl">
                      <SelectValue placeholder="Select a role" />
                    </SelectTrigger>
                    <SelectContent className="rounded-xl">
                      <SelectItem value="agent">Marketplace Agent</SelectItem>
                      <SelectItem value="admin">System Administrator</SelectItem>
                      <SelectItem value="staff">Internal Maintenance Staff</SelectItem>
