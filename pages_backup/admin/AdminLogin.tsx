...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Auth callback will handle role routing
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl space-y-8 relative overflow-hidden">
          ...
          <div className="space-y-4 relative z-10">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold tracking-tight text-white">Trimma Admin</h1>
            </div>
            <div>
          ...
          <div className="pt-4 border-t border-zinc-800 flex justify-between items-center relative z-10">
            <Link to="/login" className="text-xs text-zinc-500 hover:text-zinc-300 flex items-center gap-1">
              User Login
            </Link>
