    ...
    <div className="max-w-5xl mx-auto p-4 md:p-8 space-y-6">
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20 space-y-4">
          <Loader2 className="w-8 h-8 animate-spin text-[#ffde5a]" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-5">
          {saved.map((row) => {
            ...
            return (
              <div
                key={row.id}
                className="bg-white rounded-2xl border border-zinc-200 overflow-hidden hover:border-[#ffde5a]/50 transition-all shadow-sm"
              >
                <div className="relative aspect-[4/5] bg-zinc-100">
                  ...
                  <button
                    ...
                    className="absolute top-3 right-3 p-2 rounded-full bg-white/80 backdrop-blur-md text-[#ffde5a] hover:bg-white border border-white transition-colors disabled:opacity-50"
