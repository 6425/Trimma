            ...
            return (
              ...
              >
                ...
                <div className="p-5 space-y-3">
                  <div>
                    <Link href={linkTarget} className="font-extrabold text-zinc-900 text-lg hover:text-[#F5B700] transition-colors">
                      {ui.name}
                    </Link>
                    <div className="flex items-center gap-3 text-xs text-zinc-500 mt-1.5">
                      <span className="inline-flex items-center gap-1">
                        <Star className="w-3.5 h-3.5 text-[#F5B700] fill-[#F5B700]" />
