    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-6">
      ...
      <div className="border-b border-zinc-200 pb-6">
        <h1 className="text-2xl md:text-3xl font-black text-zinc-900 tracking-tight flex items-center gap-2">
          <LifeBuoy className="w-8 h-8 text-[#F5B700]" />
          Support & Help Center
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        ...
        <div className="bg-white rounded-2xl border border-zinc-200 p-6 flex items-start gap-4 shadow-sm hover:border-[#F5B700]/50 transition-all cursor-default">
          ...
          <div>
            ...
            <a href="mailto:support@trimma.io" className="text-sm font-bold text-[#F5B700] hover:underline">
              support@trimma.io
            </a>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-zinc-200 p-6 flex items-start gap-4 shadow-sm hover:border-[#F5B700]/50 transition-all cursor-default">
          ...
          <div>
            ...
            <a href="https://wa.me/94770000000" target="_blank" rel="noreferrer" className="text-sm font-bold text-[#F5B700] hover:underline">
              Chat on WhatsApp
            </a>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-zinc-200 p-6 flex items-start gap-4 shadow-sm hover:border-[#F5B700]/50 transition-all cursor-default">
          ...
          <div>
            ...
            <a href="tel:+94770000000" className="text-sm font-bold text-[#F5B700] hover:underline">
              +94 77 000 0000
            </a>
          </div>
        </div>
