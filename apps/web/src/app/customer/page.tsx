  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-8 space-y-8 md:space-y-12 min-w-0">
      <section className="bg-white rounded-3xl p-6 md:p-10 text-zinc-900 relative overflow-hidden shadow-sm border border-zinc-200">
        ...
        <div className="absolute -right-20 -top-20 w-64 h-64 bg-[#ffde5a]/10 blur-3xl rounded-full z-0"></div>
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 text-sm text-zinc-600">
                <Badge variant="secondary" className="bg-[#ffde5a] text-black border border-black/10 font-semibold text-xs px-2.5 py-0.5">
                  {userRole}
                </Badge>
              </div>
            </div>
          ...
          <div className="space-y-4">
            {upcomingBookings.map((booking) => {
              ...
              return (
                <div
                  key={booking.id}
                  className="p-4 rounded-xl border border-zinc-200 bg-zinc-50 hover:border-[#ffde5a]/50 hover:bg-[#ffde5a]/5 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4"
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1 text-sm text-zinc-600">
                      <CalendarDays className="w-4 h-4 text-[#ffde5a]/80" />
                      <span>
                  ...
                  <div className="text-left sm:text-right flex flex-col items-start sm:items-end gap-1.5 w-full sm:w-auto sm:max-w-[240px] shrink-0">
                    ...
                    {["confirmed", "pending", "reservation_paid"].includes(String(booking.status || "").toLowerCase()) ? (
                      <>
                        <Badge className="bg-[#ffde5a]/10 hover:bg-[#ffde5a]/20 text-[#ffde5a] border-none font-bold text-[9px] px-1.5 py-0.5 uppercase tracking-wide">
