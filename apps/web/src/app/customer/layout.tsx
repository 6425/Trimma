...
export default function CustomerDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const bottomNavItems = [
    ...
    { name: "Explore", path: "/salons", icon: <Scissors className="w-6 h-6" /> },
    ...
    <div className="min-h-screen bg-slate-50 flex font-sans">
      ...
      <aside className="hidden lg:flex flex-col w-64 fixed inset-y-0 left-0 bg-white border-r border-slate-200 z-50">
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-1">
          ...
          <Link href="/customer/profile" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-zinc-600 hover:bg-slate-100 hover:text-zinc-900 transition-colors">
             <User className="w-5 h-5" /> Profile
          </Link>
          <Link href="/customer/settings" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-zinc-600 hover:bg-slate-100 hover:text-zinc-900 transition-colors">
             <Settings className="w-5 h-5" /> Settings
          </Link>
          <Link href="/customer/support" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-zinc-600 hover:bg-slate-100 hover:text-zinc-900 transition-colors">
