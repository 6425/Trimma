              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 -mt-12 md:-mt-16 mb-8 relative z-10">
                <div className="flex flex-col md:flex-row items-center md:items-end gap-5">
                  <div className="relative group">
                    <div className="w-28 h-28 md:w-32 md:h-32 rounded-full bg-[#f9e000] text-black font-black text-4xl flex items-center justify-center shadow-lg overflow-hidden ring-4 ring-white">
                      {avatarUrl ? (
