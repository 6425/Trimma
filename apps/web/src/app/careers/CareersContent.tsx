    ...
    <div className="bg-white text-zinc-900 font-sans">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                {HERO_STATS.map((stat) => (
                  ...
                  >
                    <div className="text-lg sm:text-xl font-black text-[#ffc800]">{stat.value}</div>
            ...
            {EARNING_TIERS.map((tier) => (
              <div
                ...
                className={`relative bg-white rounded-3xl border p-8 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg ${
                  tier.popular
                    ? "border-[#ffc800] shadow-lg shadow-[#ffc800]/15 ring-2 ring-[#ffc800]/20"
                    : "border-zinc-200 shadow-sm"
                }`}
              >
                {tier.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#ffc800] text-black text-[10px] font-black uppercase tracking-widest px-4 py-1 rounded-full">
                    Most Popular
                  </div>
                )}
                ...
                <div
                  className={`inline-block text-xs font-bold px-3 py-1 rounded-full ${
                    tier.popular ? "bg-[#ffc800]/15 text-[#B8860B]" : "bg-zinc-100 text-zinc-600"
                  }`}
                >
                  {tier.label}
                </div>
            ...
            {HOW_IT_WORKS.map((item) => {
              ...
              return (
                <div key={item.step} className="text-center">
                  <div className="w-14 h-14 rounded-2xl bg-[#ffc800] text-black font-black text-xl flex items-center justify-center mx-auto mb-5 shadow-lg shadow-[#ffc800]/25">
                    {item.step}
                  </div>
                  <div className="w-12 h-12 rounded-xl bg-[#ffc800]/10 flex items-center justify-center mx-auto mb-4">
                    <Icon className="w-6 h-6 text-[#ffc800]" />
                  </div>
      ...
      <section className="py-24 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-[#0B0B0B] rounded-3xl p-8 border border-[#ffc800]/20 relative overflow-hidden">
              ...
              <div className="relative space-y-4">
                <div className="text-xs font-bold uppercase tracking-widest text-[#ffc800] mb-2">
                  Onboarding Pipeline
                </div>
                {[
                ...
                <Link
                  href="/login"
                  className="inline-flex items-center gap-2 mt-4 text-sm font-bold text-[#ffc800] hover:text-[#ffd633] transition-colors"
                >
                  Access Agent Portal
                  <ArrowRight className="w-4 h-4" />
                </Link>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {BENEFITS.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="group bg-white border border-zinc-200 hover:border-[#ffc800]/40 rounded-3xl p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
                  <div className="w-12 h-12 rounded-2xl bg-[#ffc800]/10 flex items-center justify-center mb-4 group-hover:bg-[#ffc800]/20 transition-colors">
                    <Icon className="w-6 h-6 text-[#ffc800]" />
                  </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              return (
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-[#ffc800]/10 flex items-center justify-center mx-auto mb-3">
      ...
      <section className="py-24 bg-[#0B0B0B] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <a
            href="#apply"
            className="inline-flex items-center justify-center gap-2 bg-[#ffc800] hover:bg-[#ffd633] text-black font-bold px-10 py-4 rounded-2xl transition-all hover:scale-[1.03] shadow-lg shadow-[#ffc800]/20 mb-8"
          >
            <Briefcase className="w-4 h-4" />
