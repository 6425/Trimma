  ...
  return (
    <div className="p-8 space-y-8 max-w-7xl mx-auto relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-zinc-900 tracking-tight">Service Categories</h1>
          <p className="text-zinc-500 mt-1">Manage core marketplace categories, images, and SEO slugs.</p>
        </div>
        {!editId && (
          <Button 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <tr>
                      <td colSpan={5} className="px-8 py-24 text-center">
                        <div className="max-w-xs mx-auto space-y-4">
                          <LayoutGrid className="w-12 h-12 text-zinc-300 mx-auto" />
                          <div>
                            <p className="text-zinc-500 font-bold">No categories found</p>
                          ...
                          <Button 
                            ...
                            className="bg-brand hover:bg-brand-hover text-zinc-900 w-full"
                          >
                    ...
                    filteredCategories.map((cat) => {
                      ...
                      return (
                        <tr key={cat.id} className="hover:bg-slate-50/50 transition-colors">
                          ...
                          <td className="px-8 py-6 text-center">
                            <Badge variant="outline" className="rounded-full px-3 text-emerald-600 border-emerald-200">
        ...
        <div className="space-y-6">
          <Card className={`border-none shadow-sm p-8 rounded-3xl text-zinc-900 relative overflow-hidden transition-all duration-300 ${editId ? 'bg-amber-50 border border-brand/30' : 'bg-white'}`}>
            <LayoutGrid className="absolute -right-8 -bottom-8 w-40 h-40 text-zinc-900/5 rotate-12" />
            <h3 className="text-xl font-bold mb-2 relative z-10">{editId ? 'Update Category' : 'Create Category'}</h3>
            <p className="text-zinc-500 text-sm mb-6 relative z-10">Add or manage a primary category for Trimma.</p>
            
            <form onSubmit={handleSave} className="space-y-4 relative z-10">
              
              <div className="space-y-2">
                 <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest pl-1">Category Image (16:9)</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest pl-1">Fallback Icon (Lucide)</label>
                ...
                <Input 
                  ...
                  className="bg-slate-50 border-slate-200 text-zinc-900 h-12 rounded-xl text-xs font-mono focus:ring-brand/50 focus:border-brand/50" 
              ...
              <div className="flex gap-2 pt-4">
                ...
                >
                  {saving ? <Loader2 className="w-5 h-5 animate-spin mx-auto" /> : editId ? 'Update Category' : 'Save Category'}
                </Button>
              </div>
            </form>
          </Card>
