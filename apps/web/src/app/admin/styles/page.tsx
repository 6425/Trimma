      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 shrink-0">
        <div>
          <h1 className="text-2xl font-bold text-zinc-900 tracking-tight flex items-center gap-2">
            <Scissors className="w-7 h-7 text-[#f9e000]" />
            Style Management
          </h1>
          ...
          <form onSubmit={handleSave} className="space-y-4">
            <div className="space-y-2">
              ...
              <select
                ...
                required
                className="w-full h-11 rounded-xl border border-zinc-200 bg-white px-3 text-sm text-zinc-900 focus:outline-none focus:border-[#f9e000]"
              >
            ...
            <div className="space-y-2">
              ...
              {formData.image_url ? (
                ...
                <label className="flex flex-col items-center justify-center aspect-[4/5] w-full max-w-[200px] rounded-xl border-2 border-dashed border-zinc-200 bg-slate-50 cursor-pointer hover:border-[#f9e000]/50 transition-colors">
              ...
              {formData.image_url && (
                <label className="inline-flex items-center gap-2 text-xs font-bold text-[#f9e000] cursor-pointer">
