  ...
  if (checkingSession) {
    return (
      <div className="flex min-h-[100dvh] items-center justify-center bg-[#121212] text-zinc-400">
        <Loader2 className="mr-2 h-5 w-5 animate-spin text-[#ffde5a]" />
        ...
        {sessionError ? (
          <div className="space-y-6">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 text-sm font-medium text-[#ffde5a] hover:text-[#ffe680]"
            >
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-[#ffde5a]/30 bg-[#ffde5a]/10 px-4 py-4 text-sm text-[#ffde5a]">
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-11 border-zinc-700 bg-[#1a1a1a] pl-10 pr-10 text-white placeholder:text-zinc-500 focus-visible:border-[#ffde5a] focus-visible:ring-[#ffde5a]/30"
                    />
                    <button
                      type="button"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    minLength={6}
                    autoComplete="new-password"
                    className="h-11 border-zinc-700 bg-[#1a1a1a] text-white placeholder:text-zinc-500 focus-visible:border-[#ffde5a] focus-visible:ring-[#ffde5a]/30"
                  />
                </div>
              </div>
              ...
              <Button
                type="submit"
                disabled={loading}
                className="h-11 w-full rounded-md bg-[#ffde5a] text-black hover:bg-[#ffe680] hover:text-black"
              >
                {loading ? (
                  <>
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-2 text-sm font-medium text-zinc-400 hover:text-[#ffde5a]"
              >
