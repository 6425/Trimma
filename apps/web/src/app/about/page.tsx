      ...
      <section className="py-20 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-5">
            ...
            <h2 className="text-3xl font-extrabold text-zinc-950">Headquartered in Colombo, Sri Lanka</h2>
            <p className="text-zinc-500 leading-relaxed">
              Trimma is proudly built and operated from Sri Lanka, serving salons across the island and
              expanding to support beauty and wellness businesses globally.
            </p>
          ...
          <div className="bg-white rounded-3xl border border-zinc-200 p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <div className="font-bold text-zinc-900">Trimma (Pvt) Ltd</div>
                <div className="text-sm text-zinc-500">Colombo, Sri Lanka</div>
              </div>
            </div>
            <Link
              href="/contact"
