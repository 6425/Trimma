        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="rounded-xl border border-zinc-800 bg-[#1a1a1a] px-4 py-4">
            ...
            <p className="text-sm text-zinc-400 mt-2">
              ...
              <Link href="/agent/login" className="font-medium text-[#ffc800] hover:text-[#ffd633] hover:underline">
                Partner sign in
              </Link>
            </p>
          </div>
          ...
          <p className="text-center text-sm text-zinc-400">
            New to Trimma?{" "}
            <Link href="/signup" className="font-medium text-[#ffc800] hover:text-[#ffd633] hover:underline">
              Create an account
            </Link>
          </p>
        </div>
