...
function HeroIllustration() {
  return (
    <div className="relative w-full max-w-md mx-auto">
      <div className="absolute inset-0 rounded-3xl bg-[#FFFD40]/20 blur-3xl scale-110 pointer-events-none" />
      <div className="relative bg-white rounded-3xl shadow-2xl border border-zinc-100 p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-[#FFFD40] flex items-center justify-center">
            ...
            <div key={i} className={`flex ${msg.from === "user" ? "justify-end" : "justify-start"}`}>
              <div
                className={`max-w-[80%] rounded-2xl px-4 py-2.5 text-xs leading-relaxed ${
                  msg.from === "user"
                    ? "bg-[#FFFD40] text-black font-medium"
        ...
        <div className="flex items-center gap-2 bg-zinc-50 rounded-xl px-4 py-2.5">
          ...
          <div className="w-7 h-7 rounded-lg bg-[#FFFD40] flex items-center justify-center">
            <Send className="w-3.5 h-3.5 text-black" />
          </div>
        </div>
      </div>
      <div className="absolute -top-3 -right-3 bg-[#FFFD40] text-black text-xs font-bold px-3 py-1.5 rounded-full shadow-lg flex items-center gap-1.5">
    ...
    <div className="bg-white text-zinc-900">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {CONTACT_OPTIONS.map((card) => (
              ...
              >
                ...
                <a
                  href={card.href}
                  className="inline-flex items-center gap-1.5 text-sm font-bold text-zinc-900 group-hover:text-[#FFFD40] transition-colors"
                >
                  {card.action}
      ...
      <section id="contact-form" className="py-24 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl mx-auto mb-10 bg-[#FFFD40]/10/80 border border-[#FFFD40]/30/80 rounded-2xl px-6 py-5 shadow-sm">
          ...
          {submitted ? (
            <div className="max-w-lg mx-auto bg-white border border-green-200 rounded-3xl p-10 text-center shadow-lg">
              ...
              <button
                ...
                className="text-sm font-bold text-[#FFFD40] hover:underline"
              >
            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-zinc-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#FFFD40] focus:border-transparent transition"
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      value={form.type}
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-xl border border-zinc-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#FFFD40] focus:border-transparent transition appearance-none cursor-pointer"
                    >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-zinc-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#FFFD40] focus:border-transparent transition resize-none"
                    />
                  </div>
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full flex items-center justify-center gap-2.5 bg-[#FFFD40] hover:bg-[#FFFE73] disabled:bg-[#FFFD40]/30 text-black font-bold py-4 rounded-2xl transition-all hover:scale-[1.01] active:scale-[0.99] shadow-lg shadow-[#FFFD40]/20"
              >
                {submitting ? (
                  <>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-2xl mx-auto bg-white border border-zinc-200 rounded-3xl p-8 shadow-sm">
            <div className="flex items-center gap-3 pb-6 mb-6 border-b border-zinc-100">
              <div className="w-12 h-12 rounded-2xl bg-[#FFFD40]/10 flex items-center justify-center shrink-0">
            ...
            <div className="space-y-5">
              {BUSINESS_INFO.map(({ icon: Icon, label, value, href }) => (
                <div key={label} className="flex gap-4">
                  <div className="w-10 h-10 rounded-xl bg-[#FFFD40]/10 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    {href ? (
                      <a
                        ...
                        className="text-zinc-900 font-medium text-sm hover:text-[#FFFD40] transition-colors whitespace-pre-line"
                      >
                        {value}
                      </a>
                    ) : (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-8 shadow-sm flex flex-col justify-between gap-6">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#FFFD40]/10 flex items-center justify-center shrink-0">
                  <MapPin className="w-5 h-5 text-[#FFFD40]" />
                </div>
                <div>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#FFFD40] hover:bg-[#FFFE73] text-black font-bold px-6 py-3 rounded-xl transition-all text-sm w-full sm:w-auto"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {TRUST_COMPLIANCE.map((item) => (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-[#FFFD40]/10 flex items-center justify-center shrink-0">
                  <item.icon className="w-5 h-5 text-[#FFFD40]" />
                </div>
                <div>
      ...
      <section className="py-24 bg-zinc-50">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 bg-[#FFFD40]/10 border border-[#FFFD40]/30 text-[#8a7600] text-sm font-semibold px-4 py-2 rounded-full mb-5">
      ...
      <section className="py-24 bg-zinc-950 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/onboarding"
              className="inline-flex items-center justify-center gap-2 bg-[#FFFD40] hover:bg-[#FFFE73] text-black font-bold px-10 py-4 rounded-2xl transition-all hover:scale-[1.03] shadow-lg shadow-[#FFFD40]/20"
            >
