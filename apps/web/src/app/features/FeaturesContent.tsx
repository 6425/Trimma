    ...
    <div className="overflow-hidden rounded-[2rem] border border-zinc-200 bg-white shadow-2xl shadow-zinc-200/60">
      <div className="flex items-center gap-3 border-b border-zinc-100 bg-zinc-50 px-4 py-3">
        ...
        <div className="mx-auto flex items-center gap-2 rounded-lg border border-zinc-200 bg-white px-3 py-1 text-[11px] font-semibold text-zinc-500">
          <LayoutDashboard className="h-3.5 w-3.5 text-[#FFFD40]" />
          trimma.io/dashboard
        </div>
        <span className="hidden rounded-full bg-[#FFFD40]/15 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide text-zinc-800 sm:inline">
          Salon Owner
        </span>
      </div>
...
function StepVisual({ stepIndex }: { stepIndex: number }) {
  ...
  return (
    <div className="relative w-full max-w-xl mx-auto">
      <div className="absolute inset-0 rounded-[2rem] bg-[#FFFD40]/12 blur-3xl scale-105 pointer-events-none" />
      <div className="relative overflow-hidden rounded-[1.75rem] border border-zinc-200 bg-white shadow-2xl shadow-zinc-200/70">
        <div className="flex items-center gap-2 border-b border-zinc-100 bg-zinc-50 px-4 py-3">
          ...
          <div className="mx-auto flex items-center gap-2 rounded-lg border border-zinc-200 bg-white px-3 py-1 text-[11px] font-semibold text-zinc-500">
            <Sparkles className="h-3.5 w-3.5 text-[#FFFD40]" />
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left rounded-2xl border p-5 transition-all duration-300 ${
                      isActive
                        ? "bg-white border-[#FFFD40]/40 shadow-lg shadow-[#FFFD40]/10"
                    ...
                    <div className="flex items-start gap-4">
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 font-bold text-sm ${
                          isActive ? "bg-[#FFFD40] text-black" : "bg-zinc-100 text-zinc-500"
                        }`}
                      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURE_CARDS.map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="group bg-white border border-zinc-200 hover:border-[#FFFD40]/40 rounded-3xl p-6 flex flex-col gap-4 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
                  <div className="w-12 h-12 rounded-2xl bg-[#FFFD40]/10 flex items-center justify-center group-hover:bg-[#FFFD40]/20 transition-colors">
                    <Icon className="w-6 h-6 text-[#B8860B] group-hover:text-[#FFFD40] transition-colors" />
                  </div>
                  <div>
              ...
              <div className="relative">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-xl bg-[#FFFD40]/20 flex items-center justify-center">
                    <Check className="w-5 h-5 text-[#FFFD40]" />
                  </div>
                ...
                <ul className="space-y-3">
                  {AFTER_ITEMS.map((item) => (
                    <li key={item} className="flex items-start gap-3 text-sm text-zinc-300">
                      <Check className="w-4 h-4 text-[#FFFD40] shrink-0 mt-0.5" />
                      {item}
                    </li>
                  ))}
                </ul>
            ...
            {USE_CASES.map((uc) => (
              <button
                ...
                className={`px-6 py-2.5 rounded-full text-sm font-bold transition-all ${
                  activeUseCase === uc.id
                    ? "bg-[#FFFD40] text-black shadow-lg shadow-[#FFFD40]/25"
          ...
          <div className="bg-white border border-zinc-200 rounded-3xl p-8 lg:p-12 shadow-sm grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-10 items-center">
            <div>
              <div className="inline-flex items-baseline gap-2 mb-4">
                <span className="text-4xl font-black text-[#FFFD40]">{currentUseCase.stat}</span>
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 bg-[#FFFD40] hover:bg-[#FFFE73] text-black font-bold px-6 py-3 rounded-xl transition-all"
              >
              ...
              {["Booking Flow", "Salon Profile", "Dashboard View", "Deals Page"].map((label, i) => (
                <div
                  ...
                  className={`rounded-2xl px-4 py-3 text-sm font-semibold border ${
                    i === 0
                      ? "bg-[#FFFD40]/10 border-[#FFFD40]/30 text-[#B8860B]"
            ...
            {WHY_CHOOSE.map((item) => {
              ...
              return (
                <div key={item.title} className="rounded-3xl border border-zinc-200 bg-white p-6 hover:shadow-md transition-shadow">
                  <div className="w-11 h-11 rounded-xl bg-[#FFFD40]/10 flex items-center justify-center mb-4">
                    <Icon className="w-5 h-5 text-[#FFFD40]" />
                  </div>
      ...
      <section className="py-24 bg-[#0B0B0B] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/onboarding"
              className="inline-flex items-center justify-center gap-2 border border-[#FFFD40]/50 bg-[#FFFD40]/10 text-[#FFFD40] hover:bg-[#FFFD40]/20 hover:text-[#FFFE73] font-bold px-10 py-4 rounded-2xl transition-all hover:scale-[1.03]"
            >
              <Store className="w-4 h-4" />
              List Your Salon
            </Link>
