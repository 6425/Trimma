      ...
      <section className="py-24 bg-[#0B0B0B] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/onboarding"
              className="inline-flex items-center justify-center gap-2 border border-[#ffde5a]/50 bg-[#ffde5a]/10 text-[#ffde5a] hover:bg-[#ffde5a]/20 hover:text-[#ffe680] font-bold px-10 py-4 rounded-2xl transition-all hover:scale-[1.03]"
            >
              <Store className="w-4 h-4" />
              List Your Salon
            </Link>
