...
const QUEUE_SELECT_BASE =
  "id,name,slug,category,province,district,city,address,phone,website,map_url,place_id,latitude,longitude,logo_url,hero_url,cover_url,hero_image,rating,review_count,onboarding_status,public_visibility,source_type,is_featured,description,summary,created_at";
