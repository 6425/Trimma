...
function MarketplaceMockup() {
  return (
    <div className="rounded-xl bg-[#0B0B0B] p-4 text-white space-y-3">
      ...
      <div className="bg-[#F5B700] rounded-lg p-1.5 space-y-1 border-2 border-white/20">
        ...
        <div className="bg-[#E6AC00] text-black text-[9px] font-bold py-1.5 rounded-md text-center">
          Search
        </div>
      </div>
      <div className="flex gap-2">
        <span className="bg-[#F5B700] text-black text-[9px] font-bold px-2 py-1 rounded-md">Book Now</span>
        <span className="border border-[#F5B700]/50 bg-[#F5B700]/10 text-[#F5B700] text-[9px] font-bold px-2 py-1 rounded-md">
          List Your Business
        </span>
      </div>
    </div>
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white overflow-hidden text-[10px]">
      ...
      <div className="p-3 space-y-2">
        ...
        <div className="bg-[#F5B700] text-black text-center py-1.5 rounded-lg font-bold">Continue</div>
      </div>
    </div>
  );
}
      ...
      {items.map((item) => (
        <div
          ...
          className={`px-2 py-1.5 rounded-lg text-[10px] font-semibold mb-0.5 ${
            item.active ? "bg-[#F5B700] text-black" : "text-zinc-600"
          }`}
        >
          {item.label}
        </div>
