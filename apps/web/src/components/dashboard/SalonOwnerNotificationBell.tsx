  ...
  return (
    <div
      className={`rounded-xl border p-3 transition-colors ${
        item.readAt ? "border-white/8 bg-white/3" : "border-[#F5B700]/30 bg-[#F5B700]/5"
      }`}
    >
  ...
  return (
    <DropdownMenu open={open} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 rounded-full bg-[#F5B700] text-black text-[10px] font-black flex items-center justify-center">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-white/8">
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="text-[10px] font-bold text-[#F5B700] hover:text-[#ffd54d] transition-colors"
            >
              Mark all read
            </button>
          )}
