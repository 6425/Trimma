  ...
  return (
    <div className="rounded-xl bg-[#0B0B0B] p-3 text-white w-full max-w-[220px] shrink-0">
        ...
        {items.map(({ icon: Icon, label, active }) => (
          <div
            ...
            className={`flex items-center gap-2 px-2 py-1.5 rounded-lg text-[10px] font-medium ${
              active ? "bg-[#ffde5a] text-black font-semibold" : "text-white/90"
            }`}
          >
      ...
      <div className="mt-3 pt-2 border-t border-white/10 space-y-0.5">
        ...
        <div className="flex items-center gap-2 px-2 py-1.5 rounded-lg bg-[#ffde5a] text-black text-[10px] font-semibold">
    ...
    <div className="rounded-xl bg-[#0B0B0B] border border-white/10 px-3 py-2 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative p-1.5">
          ...
          <span className="absolute top-0.5 right-0.5 w-2 h-2 rounded-full bg-[#ffde5a]" />
        </div>
        <div className="flex items-center gap-2 pl-2 border-l border-white/10">
          ...
          <div className="w-7 h-7 rounded-full bg-[#ffde5a] text-black text-[9px] font-black flex items-center justify-center border-2 border-[#ffde5a]/30">
            SA
          </div>
        </div>
      </div>
