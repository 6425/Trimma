    ...
    <>
      ...
      <div className="relative z-20 px-4 sm:px-6 flex flex-col items-center -mt-36 md:-mt-10 mb-8 sm:mb-12">
        <form
          ...
          className="trimma-hero-search bg-[#ffde5a] p-3 sm:p-2.5 md:p-1.5 rounded-2xl md:rounded-lg shadow-2xl w-full max-w-5xl flex flex-col md:flex-row gap-3 md:gap-1.5 border-[4px] border-white dark:border-[#0B0B0B]"
        >
          {/* Location */}
          <div className="flex-1 bg-white flex items-center gap-3 px-4 min-h-[52px] h-14 rounded-xl md:rounded-md border-2 border-transparent focus-within:border-[#ffde5a] transition-colors shadow-sm md:shadow-none">
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 rounded-2xl bg-white shadow-md flex items-center justify-center border-2 border-transparent group-hover:border-[#ffde5a] group-hover:bg-zinc-50 group-hover:scale-110 group-hover:-translate-y-1 transition-all duration-300">
                    <Icon className="w-5 h-5 text-zinc-600 group-hover:text-[#ffde5a] transition-colors duration-300" />
                  </div>
                  <span className="text-sm font-bold text-zinc-700 group-hover:text-[#ffde5a] transition-colors duration-300 drop-shadow-sm">
                    {cat.name}
                  </span>
                </Link>
              );
