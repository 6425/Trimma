    ...
    <section className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Card 1 */}
          <div className="bg-white border border-zinc-200 rounded-lg p-6 shadow-sm flex flex-col sm:flex-row gap-6 relative overflow-hidden">
            <div className="flex-1 z-10">
              ...
              <button className="bg-[#006CE4] hover:bg-[#0057b8] text-white font-bold px-4 py-2 rounded-md text-sm transition-colors">
                Grab deal
              </button>
            </div>
          ...
          {/* Card 2 */}
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 rounded-lg p-6 shadow-sm flex flex-col sm:flex-row gap-6 relative overflow-hidden">
            <div className="flex-1 z-10">
