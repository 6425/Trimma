...
export const CommissionCard: React.FC<Props> = ({ row }) => {
  ...
  return (
    <div className="flex items-center gap-3 p-4 rounded-xl bg-[#ffde5a]/10 border border-[#ffde5a]/30 dark:bg-[#ffde5a]/10 dark:border-[#ffde5a]/20">
      ...
      <div className="flex flex-col">
        ...
        <span className="text-xs uppercase text-[#8a7600] dark:text-[#ffde5a] mt-1">{entity_type}</span>
      </div>
    </div>
  );
};
