      ...
      >
        ...
        <div className="rounded-xl border-2 border-zinc-900 bg-white p-3 text-center">
          <QRCodeSVG
            ...
            className="mx-auto"
          />
          <span className="text-[9px] font-extrabold tracking-widest text-[#ffde5a] uppercase block mt-2">
            Scan to Book
          </span>
        </div>
      </section>
          ...
          <div className="shrink-0 mx-auto sm:mx-0">
            <div className="rounded-2xl border-2 border-zinc-900 bg-white p-4 shadow-sm text-center">
              <QRCodeSVG
                ...
                className="mx-auto"
              />
              <span className="text-[10px] font-extrabold tracking-widest text-[#ffde5a] uppercase block mt-3">
                Scan to Book
              </span>
            </div>
          </div>
