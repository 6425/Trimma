...
export function StripeCheckoutCustomerForm({
  ...
  return (
    <div className="space-y-8">
      {/* 1. Payment / card details first (Stripe embedded checkout) */}
      <section>
        ...
        <p className="text-xs text-zinc-500 mb-4">
          Enter your card below to pay the reservation deposit. Secured by Stripe.
        </p>
      ...
      {/* 2. Customer information below payment */}
      <section>
