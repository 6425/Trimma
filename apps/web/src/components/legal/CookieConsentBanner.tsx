...
export function CookieConsentBanner() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("trimma-cookie-consent-updated", reopen);
    return () => window.removeEventListener("trimma-cookie-consent-updated", reopen);
  }, []);
  ...
  const banner = (
    ...
    >
      <div
        ...
        className="w-full max-w-4xl rounded-2xl border border-zinc-200 bg-white p-5 shadow-2xl dark:border-zinc-800 dark:bg-zinc-950 sm:p-6"
      >
          ...
          {!showPreferences ? (
            <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap lg:justify-end">
              <button
                ...
                className="h-11 min-h-11 rounded-xl border border-zinc-200 px-4 text-sm font-semibold text-zinc-900 transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:text-white dark:hover:bg-zinc-900"
              >
                Manage preferences
              </button>
              <button
              ...
              <button
                ...
                className="h-11 min-h-11 rounded-xl bg-zinc-900 px-4 text-sm font-bold text-white transition-colors hover:bg-zinc-800 hover:text-[#ffde5a]"
              >
                Accept all
              </button>
            </div>
          ...
          <div className="mt-5 border-t border-zinc-100 pt-5 dark:border-zinc-800">
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:justify-end">
              ...
              <button
                ...
                className="h-11 min-h-11 rounded-xl bg-[#ffde5a] px-4 text-sm font-bold text-zinc-900 transition-colors hover:bg-[#ffe680]"
              >
                Save preferences
              </button>
            </div>
