          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-zinc-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#FFFD40] focus:border-transparent"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border border-zinc-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#FFFD40] focus:border-transparent resize-none"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full flex items-center justify-center gap-2.5 bg-[#FFFD40] hover:bg-[#FFFE73] disabled:opacity-60 text-black font-bold py-4 rounded-2xl transition-all shadow-lg shadow-[#FFFD40]/20"
            >
              {submitting ? (
                <>
