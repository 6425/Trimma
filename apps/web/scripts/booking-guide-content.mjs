...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .tag { display: inline-block; margin-top: 4px; background: rgba(245,183,0,0.15); color: #000; padding: 2px 6px; border-radius: 4px; font-size: 7pt; font-weight: 700; }
    ...
    .pick.on { border-color: ${BRAND.gold}; background: rgba(245,183,0,0.08); font-weight: 700; }
    .avatar-row { display: flex; gap: 10px; padding: 10px 12px; border-bottom: 1px solid #f1f5f9; align-items: center; }
    .avatar-row.on { background: rgba(245,183,0,0.1); }
    ...
    .gold-box { background: rgba(245,183,0,0.12); font-weight: 800; }
